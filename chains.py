...
class Chain:
    ...
    def write_mail(self, job, links):
        prompt_email = PromptTemplate.from_template(
            ...
            Write an email draft to X for a referral for the {role} role at {company}. Make it conversational and direct, without a formal tone. Limit the text to under 400 words and all the links must be in seperate lines. 
